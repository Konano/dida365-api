...
class Habit(BaseApiModel, SortableMixin, TimestampMixin):
    ...
    icon_res: Optional[str] = Field(default=None, description="Habit icon resource")
    color: Optional[str] = Field(default=None, description="Habit color")
    status: int = Field(default=0, description="Habit status")
    encouragement: Optional[str] = Field(default=None, description="Habit encouragement message")
    total_check_ins: int = Field(default=0, description="Total check-ins")
    archived_time: Optional[datetime] = Field(default=None, description="Archived time")
    type: Optional[str] = Field(default=None, description="Habit type")
    goal: float = Field(default=1.0, description="Habit goal")
    step: float = Field(default=1.0, description="Habit step")
    unit: Optional[str] = Field(default=None, description="Habit unit")
    etag: Optional[str] = Field(default=None, description="Habit etag")
    repeat_rule: Optional[str] = Field(default=None, description="Habit repeat rule")
    ...
    section_id: Optional[str] = Field(default=None, description="Habit section identifier")
    target_days: int = Field(default=0, description="Target days")
    target_start_date: Optional[int] = Field(default=None, description="Target start date in YYYYMMDD format")
...
class HabitCreate(BaseApiModel):
    ...
    icon_res: Optional[str] = Field(default=None, description="Habit icon resource")
    color: Optional[str] = Field(default=None, description="Habit color")
    sort_order: Optional[int] = Field(default=None, description="Habit sort order")
    status: Optional[int] = Field(default=None, description="Habit status")
    encouragement: Optional[str] = Field(default=None, description="Habit encouragement message")
    type: Optional[str] = Field(default=None, description="Habit type")
    goal: Optional[float] = Field(default=None, description="Habit goal")
    step: Optional[float] = Field(default=None, description="Habit step")
    unit: Optional[str] = Field(default=None, description="Habit unit")
    repeat_rule: Optional[str] = Field(default=None, description="Habit repeat rule")
    reminders: Optional[List[str]] = Field(default=None, description="Habit reminders")
    record_enable: Optional[bool] = Field(default=None, description="Whether record is enabled")
    section_id: Optional[str] = Field(default=None, description="Habit section identifier")
    target_days: Optional[int] = Field(default=None, description="Target days")
    target_start_date: Optional[int] = Field(default=None, description="Target start date in YYYYMMDD format")
    completed_cycles: Optional[int] = Field(default=None, description="Completed cycles")
    ex_dates: Optional[List[str]] = Field(default=None, description="Excluded dates")
    style: Optional[int] = Field(default=None, description="Habit style")
...
class HabitUpdate(BaseApiModel):
    ...
    name: Optional[str] = Field(default=None, description="Habit name (max 1000 characters)")
    icon_res: Optional[str] = Field(default=None, description="Habit icon resource")
    color: Optional[str] = Field(default=None, description="Habit color")
    sort_order: Optional[int] = Field(default=None, description="Habit sort order")
    status: Optional[int] = Field(default=None, description="Habit status")
...
class HabitCheckinData(BaseApiModel):
    ...
    id: Optional[str] = Field(default=None, description="Check-in id")
    stamp: int = Field(..., description="Date stamp in YYYYMMDD format")
    time: Optional[datetime] = Field(default=None, description="Check-in time")
    op_time: Optional[datetime] = Field(default=None, description="Operation time")
    value: float = Field(default=1.0, description="Check-in value")
    goal: float = Field(default=1.0, description="Check-in goal")
    status: Optional[int] = Field(default=None, description="Check-in status")


class HabitCheckin(BaseApiModel, TimestampMixin):
    """Model for a habit check-in document."""

    id: Optional[str] = Field(default=None, description="Check-in document id")
    habit_id: str = Field(..., description="Habit id")
    etag: Optional[str] = Field(default=None, description="Check-in etag")
