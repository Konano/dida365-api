...
class Countdown(BaseApiModel, SortableMixin, TimestampMixin):
    ...
    icon_res: Optional[str] = Field(default=None, description="Icon resource")
    color: Optional[str] = Field(default=None, description="Countdown color")
    ...
    show_calendar_type: Optional[int] = Field(default=None, description="Show calendar type")
    reminders: List[str] = Field(default_factory=list, description="Reminders")
    annoying_alert: Optional[int] = Field(default=None, description="Annoying alert")
    ...
    status: Optional[int] = Field(default=None, description="Countdown status")
    ...
    date_display_format: Optional[str] = Field(default=None, description="Date display format")
    timer_mode: Optional[int] = Field(default=None, description="Timer mode")
    show_age: bool = Field(default=False, description="Whether to show age")
    days_option: Optional[int] = Field(default=None, description="Days option")
